...
public abstract class BaseRadioButton extends BaseElement {
    private WebElement element;
    private RemoteWebDriver driver;
    private By locator;
    private Clickable mouse;
    final static Logger log = Logger.getLogger(BaseRadioButton.class);

    public BaseRadioButton(RemoteWebDriver driver, By locator) {
